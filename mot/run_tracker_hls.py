...
from mot.video_output import FileVideo, DisplayVideo, annotate_video_with_tracklets, annotate_video_with_tracklets_iter, annotate_video_with_tracklets_iter_vin
            ...
            if cfg.MOT.VIDEO_OUTPUT:
                annotate_video_with_tracklets_iter(os.path.join(cfg.OUTPUT_DIR,
                                            ...
                                            os.path.join(cfg.OUTPUT_DIR,
                                             ...
                                             final_tracks, "yuvj420p", cfg.FONT, cfg.FONTSIZE,count_save, 100)
